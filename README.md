## Product Management Web Application
      A simple ASP.NET Core web application for managing products with CRUD operations, built using Dapper and SQL Server. The project demonstrates clean architecture principles, responsive UI and pagination.
